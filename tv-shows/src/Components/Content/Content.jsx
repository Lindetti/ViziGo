...
const Content = () => {
  ...
  const [scienceFictionIndex, setScienceFictionIndex] = useState(0);
  ...
  useEffect(() => {
    fetch(getShowsUrl)
      ...
      .then((shows) => {
        setComedy(
          shows.filter((show) => show.genres.includes("Comedy")).slice(0, 23)
        );
        setAction(
          shows.filter((show) => show.genres.includes("Action")).slice(0, 23)
        );
        setDrama(
          shows.filter((show) => show.genres.includes("Drama")).slice(0, 23)
        );
        setAdventure(
          shows.filter((show) => show.genres.includes("Adventure")).slice(0, 23)
        );
        setScienceFiction(
          shows
            .filter(
        ...
        setHorror(
          shows.filter((show) => show.genres.includes("Horror")).slice(0, 24)
        );
      })
      .catch((error) => {
  ...
  const handleLeftClick = (category) => {
    if (category === "action" && actionIndex > 0) {
      setActionIndex(actionIndex - 6);
    } else if (category === "adventure" && adventureIndex > 0) {
      setAdventureIndex(adventureIndex - 6);
    } else if (category === "scienceFiction" && scienceFictionIndex > 0) {
      setScienceFictionIndex(scienceFictionIndex - 6);
    } else if (category === "comedy" && comedyIndex > 0) {
      setComedyIndex(comedyIndex - 6);
    } else if (category === "drama" && dramaIndex > 0) {
      setDramaIndex(dramaIndex - 6);
    } else if (category === "horror" && horrorIndex > 0) {
      setHorrorIndex(horrorIndex - 6);
    }
  };
          ...
          <div className="base-box">
            <div className="content-title">
              ...
              <div className="move-right-move-left">
                <div className="move-next-buttons">
                  <button
                    className="left"
                    onClick={() => handleLeftClick("action")}
                  ...
                  <button
                    className="right"
                    onClick={() => handleRightClick("action", action.length)}
                    disabled={actionIndex + 6 >= action.length}
                  >
            ...
            <div className="shows-wrapper">
              {action
                .slice(
                  actionIndex,
                  actionIndex + (window.innerWidth < 900 ? 4 : 6)
                )
                .map((actionItem, index) => (
                  ...
                  <div key={index} className="shows-mobile">
                    <div className="box-image">
                      <Link to={`/info/${adventureItem.id}`}>
                        <img
                          src={adventureItem.image.medium}
                          alt="tv-show-image"
                        />
                      </Link>
                    </div>
          ...
          <div className="base-box">
            <div className="content-title">
              ...
              <div className="move-right-movie-left">
                <div className="move-next-buttons">
                  <button
                    className="left"
                    onClick={() => handleLeftClick("adventure")}
                  >
                    <img src="/left.png" alt="icon" />
                  </button>
                  <button
                    className="right"
                    onClick={() =>
                      handleRightClick("adventure", adventure.length)
                    }
                  >
                    <img src="/right.png" alt="icon" />
                  </button>
            ...
            <div className="shows-wrapper">
              {adventure
                .slice(
                  adventureIndex,
                  adventureIndex + (window.innerWidth < 900 ? 4 : 6)
                )
                .map((adventureItem, index) => (
                  <div key={index} className="shows">
                    <div className="box-image">
                      <Link to={`/info/${adventureItem.id}`}>
                        <img
          ...
          <div className="base-box">
            <div className="content-title">
              ...
              <div className="move-right-movie-left">
                <div className="move-next-buttons">
                  <button
                    className="left"
                    onClick={() => handleLeftClick("comedy")}
                  >
                    <img src="/left.png" alt="icon" />
                  </button>
                  <button
                    className="right"
                    onClick={() => handleRightClick("comedy", comedy.length)}
                  >
                    <img src="/right.png" alt="icon" />
                  </button>
                </div>
            ...
            <div className="shows-wrapper">
              {comedy
                .slice(
                  comedyIndex,
                  comedyIndex + (window.innerWidth < 900 ? 4 : 6)
                )
                .map((comedyItem, index) => (
                  <div key={index} className="shows">
                    <div className="box-image">
                      <Link to={`/info/${comedyItem.id}`}>
                        <img
          ...
          <div className="base-box">
            ...
            <div className="mobile-container">
              <div className="shows-wrapper-mobile">
                {scienceFiction
                  .slice(0, 10)
                  .map((scienceFictionItem, index) => (
                    <div key={index} className="shows-mobile">
                      <div className="box-image">
                        <Link to={`/info/${scienceFictionItem.id}`}>
                          <img
                            src={scienceFictionItem.image.medium}
                            alt="tv-show-image"
                          />
                        </Link>
                      </div>
          ...
          <div className="base-box">
            <div className="content-title">
              ...
              <div className="move-right-movie-left">
                <div className="move-next-buttons">
                  <button
                    className="left"
                    onClick={() => handleLeftClick("scienceFiction")}
                  >
                    <img src="/left.png" alt="icon" />
                  </button>
                  <button
                    className="right"
                    onClick={() =>
                      handleRightClick("scienceFiction", scienceFiction.length)
                    }
                  >
                    <img src="/right.png" alt="icon" />
                  </button>
            ...
            <div className="shows-wrapper">
              {scienceFiction
                .slice(
                  scienceFictionIndex,
                  scienceFictionIndex + (window.innerWidth < 900 ? 4 : 6)
                )
                .map((comedyItem, index) => (
                  <div key={index} className="shows">
                    <div className="box-image">
          ...
          <div className="base-box">
            <div className="content-title">
              ...
              <div className="move-right-movie-left">
                <div className="move-next-buttons">
                  <button
                    className="left"
                    onClick={() => handleLeftClick("drama")}
                  >
                    <img src="/left.png" alt="icon" />
                  </button>
                  <button
                    className="right"
                    onClick={() => handleRightClick("drama", drama.length)}
                  >
                    <img src="/right.png" alt="icon" />
                  </button>
                </div>
            ...
            <div className="shows-wrapper">
              {drama
                .slice(
                  dramaIndex,
                  dramaIndex + (window.innerWidth < 900 ? 4 : 6)
                )
                .map((dramaItem, index) => (
                  <div key={index} className="shows">
                    <div className="box-image">
          ...
          <div className="base-box">
            <div className="content-title">
              ...
              <div className="move-right-movie-left">
                <div className="move-next-buttons">
                  <button
                    className="left"
                    onClick={() => handleLeftClick("horror")}
                  >
                    <img src="/left.png" alt="icon" />
                  </button>
                  <button
                    className="right"
                    onClick={() => handleRightClick("horror", horror.length)}
                  >
                    <img src="/right.png" alt="icon" />
                  </button>
                </div>
            ...
            <div className="shows-wrapper">
              {horror
                .slice(
                  horrorIndex,
                  horrorIndex + (window.innerWidth < 900 ? 4 : 6)
                )
                .map((horrorItem, index) => (
                  <div key={index} className="shows">
                    <div className="box-image">
                      <Link to={`/info/${horrorItem.id}`}>
                        <img
